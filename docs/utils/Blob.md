...
The [`Blob`](../../src/main/java/com/thetradedesk/workflows/utils/Blob.java) class provides factory methods for various input sources:
...
The [`Blob`](../../src/main/java/com/thetradedesk/workflows/utils/Blob.java) class provides four methods for reading/consuming the data. All consumption methods use NIO and are safe to use in asynchronous contexts:
