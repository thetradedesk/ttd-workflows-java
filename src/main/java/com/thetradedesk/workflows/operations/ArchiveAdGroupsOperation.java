...
public class ArchiveAdGroupsOperation implements RequestOperation<ArchiveAdGroupsRequest, ArchiveAdGroupsResponse> {
    ...
    public ArchiveAdGroupsOperation(
    ...
    public HttpRequest buildRequest(ArchiveAdGroupsRequest request) throws Exception {
