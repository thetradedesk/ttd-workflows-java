...
public class UpdateCampaignOperation implements RequestOperation<Optional<? extends CampaignUpdateWorkflowInputWithValidation>, UpdateCampaignResponse> {
    ...
    public UpdateCampaignOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CampaignUpdateWorkflowInputWithValidation> request) throws Exception {
