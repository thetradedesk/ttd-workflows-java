...
public class GetJobStatusOperation implements RequestOperation<GetJobStatusRequest, GetJobStatusResponse> {
    ...
    public HttpRequest buildRequest(GetJobStatusRequest request) throws Exception {
