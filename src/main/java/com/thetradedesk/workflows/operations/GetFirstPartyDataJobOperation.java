...
public class GetFirstPartyDataJobOperation implements RequestOperation<Optional<? extends FirstPartyDataInput>, GetFirstPartyDataJobResponse> {
    ...
    public GetFirstPartyDataJobOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends FirstPartyDataInput> request) throws Exception {
