...
public class UpdateCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CampaignUpdateWorkflowInputWithValidation>, UpdateCampaignResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends CampaignUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CampaignUpdateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CampaignUpdateWorkflowInputWithValidation> request) throws Exception {
        ...
        @Override
        public UpdateCampaignResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCampaignResponse.Builder resBuilder =
            ...
            UpdateCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends CampaignUpdateWorkflowInputWithValidation>, com.thetradedesk.workflows.models.operations.async.UpdateCampaignResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends CampaignUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CampaignUpdateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends CampaignUpdateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.UpdateCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.UpdateCampaignResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.UpdateCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.UpdateCampaignResponse res = resBuilder.build();
