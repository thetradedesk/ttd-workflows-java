...
public class CreateAdGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends AdGroupCreateWorkflowInputWithValidation>, CreateAdGroupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends AdGroupCreateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupCreateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends AdGroupCreateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CreateAdGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdGroupResponse.Builder resBuilder =
            ...
            CreateAdGroupResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdGroupPayload(Utils.unmarshal(response, new TypeReference<AdGroupPayload>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends AdGroupCreateWorkflowInputWithValidation>, com.thetradedesk.workflows.models.operations.async.CreateAdGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends AdGroupCreateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupCreateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends AdGroupCreateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.CreateAdGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.CreateAdGroupResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.CreateAdGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.CreateAdGroupResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdGroupPayload>() {})
                            .thenApply(res::withAdGroupPayload);
                } else {
