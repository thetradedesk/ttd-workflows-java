...
public class ArchiveCampaignsOperation implements RequestOperation<ArchiveCampaignsRequest, ArchiveCampaignsResponse> {
    ...
    public ArchiveCampaignsOperation(
    ...
    public HttpRequest buildRequest(ArchiveCampaignsRequest request) throws Exception {
