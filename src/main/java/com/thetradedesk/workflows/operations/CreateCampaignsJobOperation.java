...
public class CreateCampaignsJobOperation implements RequestOperation<Optional<? extends CampaignBulkCreateWorkflowInputWithValidation>, CreateCampaignsJobResponse> {
    ...
    public CreateCampaignsJobOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CampaignBulkCreateWorkflowInputWithValidation> request) throws Exception {
