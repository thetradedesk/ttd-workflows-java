...
public class GetGraphQlQueryJobStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGraphQlQueryJobStatusRequest, GetGraphQlQueryJobStatusResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetGraphQlQueryJobStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGraphQlQueryJobStatusRequest.class);
        ...
        @Override
        public GetGraphQlQueryJobStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGraphQlQueryJobStatusResponse.Builder resBuilder =
            ...
            GetGraphQlQueryJobStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GraphQLQueryJobRetrievalResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGraphQLQueryJobRetrievalResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGraphQlQueryJobStatusRequest, com.thetradedesk.workflows.models.operations.async.GetGraphQlQueryJobStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetGraphQlQueryJobStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGraphQlQueryJobStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGraphQlQueryJobStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.GetGraphQlQueryJobStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.GetGraphQlQueryJobStatusResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.GetGraphQlQueryJobStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.GetGraphQlQueryJobStatusResponse res = resBuilder.build();
