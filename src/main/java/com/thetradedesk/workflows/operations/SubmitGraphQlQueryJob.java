...
public class SubmitGraphQlQueryJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends GraphQlQueryJobInput>, SubmitGraphQlQueryJobResponse> {
        ...
        @Override
        public SubmitGraphQlQueryJobResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SubmitGraphQlQueryJobResponse.Builder resBuilder =
            ...
            SubmitGraphQlQueryJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GraphQlQueryJobResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGraphQlQueryJobResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends GraphQlQueryJobInput>, com.thetradedesk.workflows.models.operations.async.SubmitGraphQlQueryJobResponse> {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.SubmitGraphQlQueryJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.SubmitGraphQlQueryJobResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.SubmitGraphQlQueryJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.SubmitGraphQlQueryJobResponse res = resBuilder.build();
