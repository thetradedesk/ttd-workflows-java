...
public class GetCampaignVersion {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCampaignVersionRequest, GetCampaignVersionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCampaignVersionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCampaignVersionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCampaignVersionRequest request) {
        ...
        @Override
        public GetCampaignVersionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCampaignVersionWorkflow(Utils.unmarshal(response, new TypeReference<CampaignVersionWorkflow>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCampaignVersionRequest, com.thetradedesk.workflows.models.operations.async.GetCampaignVersionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCampaignVersionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCampaignVersionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCampaignVersionRequest request) {
            ...
            return retries.retry(() -> unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "403", "404", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.GetCampaignVersionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.GetCampaignVersionResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.GetCampaignVersionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.GetCampaignVersionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CampaignVersionWorkflow>() {})
                            .thenApply(res::withCampaignVersionWorkflow);
                } else {
