...
public class UpdateAdGroupsJobOperation implements RequestOperation<Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation>, UpdateAdGroupsJobResponse> {
    ...
    public UpdateAdGroupsJobOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation> request) throws Exception {
