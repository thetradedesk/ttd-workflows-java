...
public class GetGraphQlBulkJobStatus {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGraphQlBulkJobStatusRequest request) throws Exception {
        ...
        @Override
        public GetGraphQlBulkJobStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GraphQLBulkJobRetrievalResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGraphQLBulkJobRetrievalResponse(out);
                    return res;
                } else {
