...
public class GetGraphQlBulkJobStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGraphQlBulkJobStatusRequest, GetGraphQlBulkJobStatusResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetGraphQlBulkJobStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGraphQlBulkJobStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGraphQlBulkJobStatusRequest request) {
        ...
        @Override
        public GetGraphQlBulkJobStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGraphQlBulkJobStatusResponse.Builder resBuilder =
            ...
            GetGraphQlBulkJobStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGraphQLBulkJobRetrievalResponse(Utils.unmarshal(response, new TypeReference<GraphQLBulkJobRetrievalResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGraphQlBulkJobStatusRequest, com.thetradedesk.workflows.models.operations.async.GetGraphQlBulkJobStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetGraphQlBulkJobStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGraphQlBulkJobStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGraphQlBulkJobStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.GetGraphQlBulkJobStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.GetGraphQlBulkJobStatusResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.GetGraphQlBulkJobStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.GetGraphQlBulkJobStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GraphQLBulkJobRetrievalResponse>() {})
                            .thenApply(res::withGraphQLBulkJobRetrievalResponse);
                } else {
