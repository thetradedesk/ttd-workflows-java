...
public class GetJobStatus {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetJobStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetJobStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetJobStatusRequest request) {
        ...
        @Override
        public GetJobStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetJobStatusResponse.Builder resBuilder =
            ...
            GetJobStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardJobStatusResponse(Utils.unmarshal(response, new TypeReference<StandardJobStatusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetJobStatusRequest, com.thetradedesk.workflows.models.operations.async.GetJobStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetJobStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetJobStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetJobStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.GetJobStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.GetJobStatusResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.GetJobStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.GetJobStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<StandardJobStatusResponse>() {})
                            .thenApply(res::withStandardJobStatusResponse);
                } else {
