...
public class SubmitGraphQlQueryJobOperation implements RequestOperation<Optional<? extends GraphQlQueryJobInput>, SubmitGraphQlQueryJobResponse> {
    ...
    public SubmitGraphQlQueryJobOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends GraphQlQueryJobInput> request) throws Exception {
