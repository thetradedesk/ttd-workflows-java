...
public class UpdateAdGroup {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(Optional<? extends AdGroupUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupUpdateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends AdGroupUpdateWorkflowInputWithValidation> request) {
        ...
        @Override
        public UpdateAdGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdGroupResponse.Builder resBuilder =
            ...
            UpdateAdGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends AdGroupUpdateWorkflowInputWithValidation>, com.thetradedesk.workflows.models.operations.async.UpdateAdGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends AdGroupUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupUpdateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends AdGroupUpdateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.UpdateAdGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.UpdateAdGroupResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.UpdateAdGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.UpdateAdGroupResponse res = resBuilder.build();
