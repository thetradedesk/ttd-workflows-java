...
public class ArchiveCampaigns {
    ...
    public static class Sync extends Base
            implements RequestOperation<ArchiveCampaignsRequest, ArchiveCampaignsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ArchiveCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ArchiveCampaignsRequest.class, new TypeReference<ArchiveCampaignsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ArchiveCampaignsRequest request) {
        ...
        @Override
        public ArchiveCampaignsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ArchiveCampaignsResponse.Builder resBuilder =
            ...
            ArchiveCampaignsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStrings(Utils.unmarshal(response, new TypeReference<List<String>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ArchiveCampaignsRequest, com.thetradedesk.workflows.models.operations.async.ArchiveCampaignsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ArchiveCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ArchiveCampaignsRequest.class, new TypeReference<ArchiveCampaignsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ArchiveCampaignsRequest request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.ArchiveCampaignsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.ArchiveCampaignsResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.ArchiveCampaignsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.ArchiveCampaignsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<String>>() {})
                            .thenApply(res::withStrings);
                } else {
