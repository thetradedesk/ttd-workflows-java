...
public class GetGraphQlQueryJobStatusOperation implements RequestOperation<GetGraphQlQueryJobStatusRequest, GetGraphQlQueryJobStatusResponse> {
    ...
    public GetGraphQlQueryJobStatusOperation(
    ...
    public HttpRequest buildRequest(GetGraphQlQueryJobStatusRequest request) throws Exception {
