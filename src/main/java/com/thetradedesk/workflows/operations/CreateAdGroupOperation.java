...
public class CreateAdGroupOperation implements RequestOperation<Optional<? extends AdGroupCreateWorkflowInputWithValidation>, CreateAdGroupResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends AdGroupCreateWorkflowInputWithValidation> request) throws Exception {
