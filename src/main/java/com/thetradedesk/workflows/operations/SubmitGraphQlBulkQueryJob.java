...
public class SubmitGraphQlBulkQueryJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends GraphQlQueryJobInput>, SubmitGraphQlBulkQueryJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends GraphQlQueryJobInput> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends GraphQlQueryJobInput>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends GraphQlQueryJobInput> request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "4XX", "500", "503", "5XX")) {
        ...
        @Override
        public SubmitGraphQlBulkQueryJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SubmitGraphQlBulkQueryJobResponse.Builder resBuilder =
            ...
            SubmitGraphQlBulkQueryJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGraphQlBulkJobResponse(Utils.unmarshal(response, new TypeReference<GraphQlBulkJobResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends GraphQlQueryJobInput>, com.thetradedesk.workflows.models.operations.async.SubmitGraphQlBulkQueryJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends GraphQlQueryJobInput> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends GraphQlQueryJobInput>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends GraphQlQueryJobInput> request) {
            ...
            return retries.retry(() -> unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "403", "404", "4XX", "500", "503", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.SubmitGraphQlBulkQueryJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.SubmitGraphQlBulkQueryJobResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.SubmitGraphQlBulkQueryJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.SubmitGraphQlBulkQueryJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GraphQlBulkJobResponse>() {})
                            .thenApply(res::withGraphQlBulkJobResponse);
                } else {
