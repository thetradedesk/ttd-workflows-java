...
public class SubmitGraphQlBulkQueryJob {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends GraphQlQueryJobInput> request) throws Exception {
        ...
        @Override
        public SubmitGraphQlBulkQueryJobResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GraphQlBulkJobResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGraphQlBulkJobResponse(out);
                    return res;
                } else {
