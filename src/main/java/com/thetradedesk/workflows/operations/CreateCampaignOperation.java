...
public class CreateCampaignOperation implements RequestOperation<Optional<? extends CampaignCreateWorkflowInputWithValidation>, CreateCampaignResponse> {
    ...
    public CreateCampaignOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CampaignCreateWorkflowInputWithValidation> request) throws Exception {
