...
public class UpdateAdGroupsJob {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation> request) {
        ...
        @Override
        public UpdateAdGroupsJobResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation>, com.thetradedesk.workflows.models.operations.async.UpdateAdGroupsJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends AdGroupBulkUpdateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.UpdateAdGroupsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.UpdateAdGroupsJobResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.UpdateAdGroupsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.UpdateAdGroupsJobResponse res = resBuilder.build();
