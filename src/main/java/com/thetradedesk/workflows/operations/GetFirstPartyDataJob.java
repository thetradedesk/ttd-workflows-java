...
public class GetFirstPartyDataJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends FirstPartyDataInput>, GetFirstPartyDataJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends FirstPartyDataInput> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends FirstPartyDataInput>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends FirstPartyDataInput> request) throws Exception {
        ...
        @Override
        public GetFirstPartyDataJobResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFirstPartyDataJobResponse.Builder resBuilder =
            ...
            GetFirstPartyDataJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends FirstPartyDataInput>, com.thetradedesk.workflows.models.operations.async.GetFirstPartyDataJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends FirstPartyDataInput> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends FirstPartyDataInput>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends FirstPartyDataInput> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.GetFirstPartyDataJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.GetFirstPartyDataJobResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.GetFirstPartyDataJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.GetFirstPartyDataJobResponse res = resBuilder.build();
