...
public class UpdateCampaignsJob {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(Optional<? extends CampaignBulkUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CampaignBulkUpdateWorkflowInputWithValidation>>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends CampaignBulkUpdateWorkflowInputWithValidation>, com.thetradedesk.workflows.models.operations.async.UpdateCampaignsJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends CampaignBulkUpdateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CampaignBulkUpdateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends CampaignBulkUpdateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.UpdateCampaignsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.UpdateCampaignsJobResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.UpdateCampaignsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.UpdateCampaignsJobResponse res = resBuilder.build();
