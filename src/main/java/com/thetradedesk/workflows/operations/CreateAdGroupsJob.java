...
public class CreateAdGroupsJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation>, CreateAdGroupsJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CreateAdGroupsJobResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation>, com.thetradedesk.workflows.models.operations.async.CreateAdGroupsJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends AdGroupBulkCreateWorkflowInputWithValidation> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.CreateAdGroupsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.CreateAdGroupsJobResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.CreateAdGroupsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.CreateAdGroupsJobResponse res = resBuilder.build();
