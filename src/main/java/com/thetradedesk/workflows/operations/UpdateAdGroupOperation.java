...
public class UpdateAdGroupOperation implements RequestOperation<Optional<? extends AdGroupUpdateWorkflowInputWithValidation>, UpdateAdGroupResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends AdGroupUpdateWorkflowInputWithValidation> request) throws Exception {
