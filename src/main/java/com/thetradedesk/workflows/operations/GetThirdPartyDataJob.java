...
public class GetThirdPartyDataJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends ThirdPartyDataInput>, GetThirdPartyDataJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends ThirdPartyDataInput> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends ThirdPartyDataInput>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends ThirdPartyDataInput> request) {
        ...
        @Override
        public GetThirdPartyDataJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetThirdPartyDataJobResponse.Builder resBuilder =
            ...
            GetThirdPartyDataJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends ThirdPartyDataInput>, com.thetradedesk.workflows.models.operations.async.GetThirdPartyDataJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends ThirdPartyDataInput> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends ThirdPartyDataInput>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends ThirdPartyDataInput> request) {
        ...
        @Override
        public CompletableFuture<com.thetradedesk.workflows.models.operations.async.GetThirdPartyDataJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.thetradedesk.workflows.models.operations.async.GetThirdPartyDataJobResponse.Builder resBuilder =
                    com.thetradedesk.workflows.models.operations.async.GetThirdPartyDataJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.thetradedesk.workflows.models.operations.async.GetThirdPartyDataJobResponse res = resBuilder.build();
