...
public class GetThirdPartyDataJobOperation implements RequestOperation<Optional<? extends ThirdPartyDataInput>, GetThirdPartyDataJobResponse> {
    ...
    public GetThirdPartyDataJobOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends ThirdPartyDataInput> request) throws Exception {
