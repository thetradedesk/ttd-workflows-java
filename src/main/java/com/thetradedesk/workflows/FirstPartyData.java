...
import com.thetradedesk.workflows.models.operations.PostTypebasedjobFirstpartydataRequestBuilder;
...
public class FirstPartyData implements
            MethodCallPostTypebasedjobFirstpartydata {

    private final SDKConfiguration sdkConfiguration;

    FirstPartyData(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    /**
     * Submit a type-based job for first-party data retrieval for an advertiser
     * 
     ...
     */
    public PostTypebasedjobFirstpartydataRequestBuilder postTypebasedjobFirstpartydata() {
        return new PostTypebasedjobFirstpartydataRequestBuilder(this);
    }
     ...
     */
    public PostTypebasedjobFirstpartydataResponse postTypebasedjobFirstpartydataDirect() throws Exception {
        return postTypebasedjobFirstpartydata(Optional.empty(), Optional.empty());
    }
     ...
     * @throws Exception if the API call fails
     */
    public PostTypebasedjobFirstpartydataResponse postTypebasedjobFirstpartydata(
                    ...
                    _r = sdkConfiguration.hooks()
                        .beforeRequest(
                            new BeforeRequestContextImpl(
                                ...
                                _baseUrl,
                                "post_/typebasedjob/firstpartydata", 
                                Optional.of(List.of()), 
                                _hookSecuritySource),
                            _finalReq.build());
                } catch (Exception _e) {
        ...
        PostTypebasedjobFirstpartydataResponse.Builder _resBuilder = 
            PostTypebasedjobFirstpartydataResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        PostTypebasedjobFirstpartydataResponse _res = _resBuilder.build();
