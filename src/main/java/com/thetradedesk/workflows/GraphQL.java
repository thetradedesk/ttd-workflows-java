...
public class GraphQL implements
     ...
     */
    public PostGraphqlRequestBuilder postGraphql() {
     ...
     */
    public PostGraphqlResponse postGraphqlDirect() throws Exception {
        return postGraphql(Optional.empty(), Optional.empty());
    }
     ...
     * @throws Exception if the API call fails
     */
    public PostGraphqlResponse postGraphql(
