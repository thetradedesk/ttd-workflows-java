...
public class AdGroupROIGoal {
    ...
    public AdGroupROIGoal withNewBuyerTargetValue(int newBuyerTargetValue) {
        Utils.checkNotNull(newBuyerTargetValue, "newBuyerTargetValue");
        this.newBuyerTargetValue = JsonNullable.of(newBuyerTargetValue);
        return this;
    }

    public AdGroupROIGoal withNewBuyerTargetValue(JsonNullable<Integer> newBuyerTargetValue) {
        Utils.checkNotNull(newBuyerTargetValue, "newBuyerTargetValue");
        this.newBuyerTargetValue = newBuyerTargetValue;
        return this;
    }
