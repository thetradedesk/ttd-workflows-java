...
public class AdGroupContractTargetingInput {
    ...
    @JsonCreator
    public AdGroupContractTargetingInput(
    ...
    public AdGroupContractTargetingInput withAllowOpenMarketBiddingWhenTargetingContracts(boolean allowOpenMarketBiddingWhenTargetingContracts) {
        Utils.checkNotNull(allowOpenMarketBiddingWhenTargetingContracts, "allowOpenMarketBiddingWhenTargetingContracts");
        this.allowOpenMarketBiddingWhenTargetingContracts = JsonNullable.of(allowOpenMarketBiddingWhenTargetingContracts);
        return this;
    }

    public AdGroupContractTargetingInput withAllowOpenMarketBiddingWhenTargetingContracts(JsonNullable<Boolean> allowOpenMarketBiddingWhenTargetingContracts) {
        Utils.checkNotNull(allowOpenMarketBiddingWhenTargetingContracts, "allowOpenMarketBiddingWhenTargetingContracts");
        this.allowOpenMarketBiddingWhenTargetingContracts = allowOpenMarketBiddingWhenTargetingContracts;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AdGroupContractTargetingInput other = (AdGroupContractTargetingInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AdGroupContractTargetingInput.class,
    ...
    public final static class Builder {
        ...
        public AdGroupContractTargetingInput build() {
            return new AdGroupContractTargetingInput(
                allowOpenMarketBiddingWhenTargetingContracts);
        }
    }
}
