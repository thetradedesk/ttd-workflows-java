...
public enum DimensionalBiddingDimensions {
    ...
    public static Optional<DimensionalBiddingDimensions> fromValue(String value) {
        for (DimensionalBiddingDimensions o: DimensionalBiddingDimensions.values()) {
