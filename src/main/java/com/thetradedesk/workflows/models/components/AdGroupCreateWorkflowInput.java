...
public class AdGroupCreateWorkflowInput {
    ...
    private Optional<? extends AdGroupCreateAdvancedSettingsInput> advancedSettings;
    ...
    public AdGroupCreateWorkflowInput(
            ...
            @JsonProperty("advancedSettings") Optional<? extends AdGroupCreateAdvancedSettingsInput> advancedSettings) {
    ...
    public AdGroupCreateWorkflowInput(
        ...
        this(Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), channel, funnelLocation, Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), Optional.empty());
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<AdGroupCreateAdvancedSettingsInput> advancedSettings() {
        return (Optional<AdGroupCreateAdvancedSettingsInput>) advancedSettings;
    }
    ...
    public AdGroupCreateWorkflowInput withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = Optional.ofNullable(name);
        return this;
    }

    public AdGroupCreateWorkflowInput withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public AdGroupCreateWorkflowInput withIsEnabled(boolean isEnabled) {
        Utils.checkNotNull(isEnabled, "isEnabled");
        this.isEnabled = JsonNullable.of(isEnabled);
        return this;
    }

    public AdGroupCreateWorkflowInput withIsEnabled(JsonNullable<Boolean> isEnabled) {
        Utils.checkNotNull(isEnabled, "isEnabled");
        this.isEnabled = isEnabled;
        return this;
    }

    public AdGroupCreateWorkflowInput withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = JsonNullable.of(description);
        return this;
    }

    public AdGroupCreateWorkflowInput withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public AdGroupCreateWorkflowInput withProgrammaticGuaranteedPrivateContractId(String programmaticGuaranteedPrivateContractId) {
        Utils.checkNotNull(programmaticGuaranteedPrivateContractId, "programmaticGuaranteedPrivateContractId");
        this.programmaticGuaranteedPrivateContractId = JsonNullable.of(programmaticGuaranteedPrivateContractId);
        return this;
    }

    public AdGroupCreateWorkflowInput withProgrammaticGuaranteedPrivateContractId(JsonNullable<String> programmaticGuaranteedPrivateContractId) {
        Utils.checkNotNull(programmaticGuaranteedPrivateContractId, "programmaticGuaranteedPrivateContractId");
        this.programmaticGuaranteedPrivateContractId = programmaticGuaranteedPrivateContractId;
        return this;
    }

    public AdGroupCreateWorkflowInput withChannel(AdGroupChannel channel) {
        Utils.checkNotNull(channel, "channel");
        this.channel = channel;
        return this;
    }

    public AdGroupCreateWorkflowInput withFunnelLocation(AdGroupFunnelLocation funnelLocation) {
        Utils.checkNotNull(funnelLocation, "funnelLocation");
        this.funnelLocation = funnelLocation;
        return this;
    }

    public AdGroupCreateWorkflowInput withBudget(AdGroupBudgetInput budget) {
        Utils.checkNotNull(budget, "budget");
        this.budget = Optional.ofNullable(budget);
        return this;
    }

    public AdGroupCreateWorkflowInput withBudget(Optional<? extends AdGroupBudgetInput> budget) {
        Utils.checkNotNull(budget, "budget");
        this.budget = budget;
        return this;
    }

    public AdGroupCreateWorkflowInput withBaseBidCPMInAdvertiserCurrency(double baseBidCPMInAdvertiserCurrency) {
        Utils.checkNotNull(baseBidCPMInAdvertiserCurrency, "baseBidCPMInAdvertiserCurrency");
        this.baseBidCPMInAdvertiserCurrency = JsonNullable.of(baseBidCPMInAdvertiserCurrency);
        return this;
    }

    public AdGroupCreateWorkflowInput withBaseBidCPMInAdvertiserCurrency(JsonNullable<Double> baseBidCPMInAdvertiserCurrency) {
        Utils.checkNotNull(baseBidCPMInAdvertiserCurrency, "baseBidCPMInAdvertiserCurrency");
        this.baseBidCPMInAdvertiserCurrency = baseBidCPMInAdvertiserCurrency;
        return this;
    }

    public AdGroupCreateWorkflowInput withMaxBidCPMInAdvertiserCurrency(double maxBidCPMInAdvertiserCurrency) {
        Utils.checkNotNull(maxBidCPMInAdvertiserCurrency, "maxBidCPMInAdvertiserCurrency");
        this.maxBidCPMInAdvertiserCurrency = JsonNullable.of(maxBidCPMInAdvertiserCurrency);
        return this;
    }

    public AdGroupCreateWorkflowInput withMaxBidCPMInAdvertiserCurrency(JsonNullable<Double> maxBidCPMInAdvertiserCurrency) {
        Utils.checkNotNull(maxBidCPMInAdvertiserCurrency, "maxBidCPMInAdvertiserCurrency");
        this.maxBidCPMInAdvertiserCurrency = maxBidCPMInAdvertiserCurrency;
        return this;
    }

    public AdGroupCreateWorkflowInput withAudienceTargeting(AdGroupAudienceTargetingInput audienceTargeting) {
        Utils.checkNotNull(audienceTargeting, "audienceTargeting");
        this.audienceTargeting = Optional.ofNullable(audienceTargeting);
        return this;
    }

    public AdGroupCreateWorkflowInput withAudienceTargeting(Optional<? extends AdGroupAudienceTargetingInput> audienceTargeting) {
        Utils.checkNotNull(audienceTargeting, "audienceTargeting");
        this.audienceTargeting = audienceTargeting;
        return this;
    }

    public AdGroupCreateWorkflowInput withRoiGoal(AdGroupRoiGoalInput roiGoal) {
        Utils.checkNotNull(roiGoal, "roiGoal");
        this.roiGoal = Optional.ofNullable(roiGoal);
        return this;
    }

    public AdGroupCreateWorkflowInput withRoiGoal(Optional<? extends AdGroupRoiGoalInput> roiGoal) {
        Utils.checkNotNull(roiGoal, "roiGoal");
        this.roiGoal = roiGoal;
        return this;
    }

    public AdGroupCreateWorkflowInput withCreativeIds(List<String> creativeIds) {
        Utils.checkNotNull(creativeIds, "creativeIds");
        this.creativeIds = JsonNullable.of(creativeIds);
        return this;
    }

    public AdGroupCreateWorkflowInput withCreativeIds(JsonNullable<? extends List<String>> creativeIds) {
        Utils.checkNotNull(creativeIds, "creativeIds");
        this.creativeIds = creativeIds;
        return this;
    }

    public AdGroupCreateWorkflowInput withAssociatedBidLists(List<AdGroupAssociateBidListInput> associatedBidLists) {
        Utils.checkNotNull(associatedBidLists, "associatedBidLists");
        this.associatedBidLists = JsonNullable.of(associatedBidLists);
        return this;
    }

    public AdGroupCreateWorkflowInput withAssociatedBidLists(JsonNullable<? extends List<AdGroupAssociateBidListInput>> associatedBidLists) {
        Utils.checkNotNull(associatedBidLists, "associatedBidLists");
        this.associatedBidLists = associatedBidLists;
        return this;
    }
    ...
    public AdGroupCreateWorkflowInput withAdvancedSettings(AdGroupCreateAdvancedSettingsInput advancedSettings) {
        Utils.checkNotNull(advancedSettings, "advancedSettings");
        this.advancedSettings = Optional.ofNullable(advancedSettings);
        return this;
    }

    public AdGroupCreateWorkflowInput withAdvancedSettings(Optional<? extends AdGroupCreateAdvancedSettingsInput> advancedSettings) {
        Utils.checkNotNull(advancedSettings, "advancedSettings");
        this.advancedSettings = advancedSettings;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends AdGroupCreateAdvancedSettingsInput> advancedSettings = Optional.empty();
        ...
        public Builder advancedSettings(AdGroupCreateAdvancedSettingsInput advancedSettings) {
            Utils.checkNotNull(advancedSettings, "advancedSettings");
            this.advancedSettings = Optional.ofNullable(advancedSettings);
            return this;
        }

        public Builder advancedSettings(Optional<? extends AdGroupCreateAdvancedSettingsInput> advancedSettings) {
            Utils.checkNotNull(advancedSettings, "advancedSettings");
            this.advancedSettings = advancedSettings;
            return this;
        }
