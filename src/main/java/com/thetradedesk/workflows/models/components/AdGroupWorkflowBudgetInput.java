...
public class AdGroupWorkflowBudgetInput {
    ...
    public AdGroupWorkflowBudgetInput withBudgetInAdvertiserCurrency(double budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = JsonNullable.of(budgetInAdvertiserCurrency);
        return this;
    }

    public AdGroupWorkflowBudgetInput withBudgetInAdvertiserCurrency(JsonNullable<Double> budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = budgetInAdvertiserCurrency;
        return this;
    }

    public AdGroupWorkflowBudgetInput withBudgetInImpressions(long budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = JsonNullable.of(budgetInImpressions);
        return this;
    }

    public AdGroupWorkflowBudgetInput withBudgetInImpressions(JsonNullable<Long> budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = budgetInImpressions;
        return this;
    }

    public AdGroupWorkflowBudgetInput withDailyTargetInAdvertiserCurrency(double dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = JsonNullable.of(dailyTargetInAdvertiserCurrency);
        return this;
    }

    public AdGroupWorkflowBudgetInput withDailyTargetInAdvertiserCurrency(JsonNullable<Double> dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = dailyTargetInAdvertiserCurrency;
        return this;
    }

    public AdGroupWorkflowBudgetInput withDailyTargetInImpressions(long dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = JsonNullable.of(dailyTargetInImpressions);
        return this;
    }

    public AdGroupWorkflowBudgetInput withDailyTargetInImpressions(JsonNullable<Long> dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = dailyTargetInImpressions;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AdGroupWorkflowBudgetInput.class,
