...
public class AdGroupUpdateComscoreSettingsInput {
    ...
    @JsonCreator
    public AdGroupUpdateComscoreSettingsInput(
    ...
    public AdGroupUpdateComscoreSettingsInput withIsEnabled(boolean isEnabled) {
        Utils.checkNotNull(isEnabled, "isEnabled");
        this.isEnabled = JsonNullable.of(isEnabled);
        return this;
    }

    public AdGroupUpdateComscoreSettingsInput withIsEnabled(JsonNullable<Boolean> isEnabled) {
        Utils.checkNotNull(isEnabled, "isEnabled");
        this.isEnabled = isEnabled;
        return this;
    }

    public AdGroupUpdateComscoreSettingsInput withPopulationId(int populationId) {
        Utils.checkNotNull(populationId, "populationId");
        this.populationId = JsonNullable.of(populationId);
        return this;
    }

    public AdGroupUpdateComscoreSettingsInput withPopulationId(JsonNullable<Integer> populationId) {
        Utils.checkNotNull(populationId, "populationId");
        this.populationId = populationId;
        return this;
    }

    public AdGroupUpdateComscoreSettingsInput withDemographicMemberIds(List<Integer> demographicMemberIds) {
        Utils.checkNotNull(demographicMemberIds, "demographicMemberIds");
        this.demographicMemberIds = JsonNullable.of(demographicMemberIds);
        return this;
    }

    public AdGroupUpdateComscoreSettingsInput withDemographicMemberIds(JsonNullable<? extends List<Integer>> demographicMemberIds) {
        Utils.checkNotNull(demographicMemberIds, "demographicMemberIds");
        this.demographicMemberIds = demographicMemberIds;
        return this;
    }

    public AdGroupUpdateComscoreSettingsInput withMobileDemographicMemberIds(List<Integer> mobileDemographicMemberIds) {
        Utils.checkNotNull(mobileDemographicMemberIds, "mobileDemographicMemberIds");
        this.mobileDemographicMemberIds = JsonNullable.of(mobileDemographicMemberIds);
        return this;
    }

    public AdGroupUpdateComscoreSettingsInput withMobileDemographicMemberIds(JsonNullable<? extends List<Integer>> mobileDemographicMemberIds) {
        Utils.checkNotNull(mobileDemographicMemberIds, "mobileDemographicMemberIds");
        this.mobileDemographicMemberIds = mobileDemographicMemberIds;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AdGroupUpdateComscoreSettingsInput other = (AdGroupUpdateComscoreSettingsInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AdGroupUpdateComscoreSettingsInput.class,
                "isEnabled", isEnabled,
    ...
    public final static class Builder {
        ...
        public AdGroupUpdateComscoreSettingsInput build() {
            return new AdGroupUpdateComscoreSettingsInput(
                isEnabled,
                populationId,
                demographicMemberIds,
                mobileDemographicMemberIds);
