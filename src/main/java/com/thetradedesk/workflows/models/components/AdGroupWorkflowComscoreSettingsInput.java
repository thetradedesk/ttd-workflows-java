...
public class AdGroupWorkflowComscoreSettingsInput {
    ...
    public AdGroupWorkflowComscoreSettingsInput withPopulationId(int populationId) {
        Utils.checkNotNull(populationId, "populationId");
        this.populationId = JsonNullable.of(populationId);
        return this;
    }

    public AdGroupWorkflowComscoreSettingsInput withPopulationId(JsonNullable<Integer> populationId) {
        Utils.checkNotNull(populationId, "populationId");
        this.populationId = populationId;
        return this;
    }

    public AdGroupWorkflowComscoreSettingsInput withDemographicMemberIds(List<Integer> demographicMemberIds) {
        Utils.checkNotNull(demographicMemberIds, "demographicMemberIds");
        this.demographicMemberIds = JsonNullable.of(demographicMemberIds);
        return this;
    }

    public AdGroupWorkflowComscoreSettingsInput withDemographicMemberIds(JsonNullable<? extends List<Integer>> demographicMemberIds) {
        Utils.checkNotNull(demographicMemberIds, "demographicMemberIds");
        this.demographicMemberIds = demographicMemberIds;
        return this;
    }

    public AdGroupWorkflowComscoreSettingsInput withMobileDemographicMemberIds(List<Integer> mobileDemographicMemberIds) {
        Utils.checkNotNull(mobileDemographicMemberIds, "mobileDemographicMemberIds");
        this.mobileDemographicMemberIds = JsonNullable.of(mobileDemographicMemberIds);
        return this;
    }

    public AdGroupWorkflowComscoreSettingsInput withMobileDemographicMemberIds(JsonNullable<? extends List<Integer>> mobileDemographicMemberIds) {
        Utils.checkNotNull(mobileDemographicMemberIds, "mobileDemographicMemberIds");
        this.mobileDemographicMemberIds = mobileDemographicMemberIds;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AdGroupWorkflowComscoreSettingsInput.class,
                "isEnabled", isEnabled,
