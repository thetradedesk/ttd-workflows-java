...
public enum TargetingEndAgeInput {
    SEVENTEEN("Seventeen"),
    TWENTY("Twenty"),
    ...
    TargetingEndAgeInput(String value) {
        this.value = value;
    }
    ...
    public static Optional<TargetingEndAgeInput> fromValue(String value) {
        for (TargetingEndAgeInput o: TargetingEndAgeInput.values()) {
