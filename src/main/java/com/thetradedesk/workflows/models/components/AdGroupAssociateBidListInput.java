...
public class AdGroupAssociateBidListInput {
    ...
    @JsonCreator
    public AdGroupAssociateBidListInput(
    ...
    public AdGroupAssociateBidListInput withBidListId(String bidListId) {
        Utils.checkNotNull(bidListId, "bidListId");
        this.bidListId = bidListId;
        return this;
    }

    public AdGroupAssociateBidListInput withIsEnabled(boolean isEnabled) {
        Utils.checkNotNull(isEnabled, "isEnabled");
        this.isEnabled = JsonNullable.of(isEnabled);
        return this;
    }

    public AdGroupAssociateBidListInput withIsEnabled(JsonNullable<Boolean> isEnabled) {
        Utils.checkNotNull(isEnabled, "isEnabled");
        this.isEnabled = isEnabled;
        return this;
    }

    public AdGroupAssociateBidListInput withIsDefaultForDimension(boolean isDefaultForDimension) {
        Utils.checkNotNull(isDefaultForDimension, "isDefaultForDimension");
        this.isDefaultForDimension = JsonNullable.of(isDefaultForDimension);
        return this;
    }

    public AdGroupAssociateBidListInput withIsDefaultForDimension(JsonNullable<Boolean> isDefaultForDimension) {
        Utils.checkNotNull(isDefaultForDimension, "isDefaultForDimension");
        this.isDefaultForDimension = isDefaultForDimension;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AdGroupAssociateBidListInput other = (AdGroupAssociateBidListInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AdGroupAssociateBidListInput.class,
                "bidListId", bidListId,
                "isEnabled", isEnabled,
    ...
    public final static class Builder {
        ...
        public AdGroupAssociateBidListInput build() {
            return new AdGroupAssociateBidListInput(
                bidListId,
                isEnabled,
                isDefaultForDimension);
        }
