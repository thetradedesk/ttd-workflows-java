...
public class AdGroupFlightInput {
    ...
    public AdGroupFlightInput withAllocationType(AllocationType allocationType) {
        Utils.checkNotNull(allocationType, "allocationType");
        this.allocationType = Optional.ofNullable(allocationType);
        return this;
    }

    public AdGroupFlightInput withAllocationType(Optional<? extends AllocationType> allocationType) {
        Utils.checkNotNull(allocationType, "allocationType");
        this.allocationType = allocationType;
        return this;
    }

    public AdGroupFlightInput withBudgetInAdvertiserCurrency(double budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = JsonNullable.of(budgetInAdvertiserCurrency);
        return this;
    }

    public AdGroupFlightInput withBudgetInAdvertiserCurrency(JsonNullable<Double> budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = budgetInAdvertiserCurrency;
        return this;
    }

    public AdGroupFlightInput withBudgetInImpressions(long budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = JsonNullable.of(budgetInImpressions);
        return this;
    }

    public AdGroupFlightInput withBudgetInImpressions(JsonNullable<Long> budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = budgetInImpressions;
        return this;
    }

    public AdGroupFlightInput withDailyTargetInAdvertiserCurrency(double dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = JsonNullable.of(dailyTargetInAdvertiserCurrency);
        return this;
    }

    public AdGroupFlightInput withDailyTargetInAdvertiserCurrency(JsonNullable<Double> dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = dailyTargetInAdvertiserCurrency;
        return this;
    }

    public AdGroupFlightInput withDailyTargetInImpressions(long dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = JsonNullable.of(dailyTargetInImpressions);
        return this;
    }

    public AdGroupFlightInput withDailyTargetInImpressions(JsonNullable<Long> dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = dailyTargetInImpressions;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AdGroupFlightInput other = (AdGroupFlightInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AdGroupFlightInput.class,
    ...
    public final static class Builder {
        ...
        public AdGroupFlightInput build() {
            return new AdGroupFlightInput(
                allocationType,
                budgetInAdvertiserCurrency,
                budgetInImpressions,
                dailyTargetInAdvertiserCurrency,
