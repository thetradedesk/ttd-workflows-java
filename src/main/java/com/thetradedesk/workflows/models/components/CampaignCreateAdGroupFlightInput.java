...
public class CampaignCreateAdGroupFlightInput {
    ...
    @JsonCreator
    public CampaignCreateAdGroupFlightInput(
    ...
    public CampaignCreateAdGroupFlightInput withAllocationType(AllocationType allocationType) {
        Utils.checkNotNull(allocationType, "allocationType");
        this.allocationType = Optional.ofNullable(allocationType);
        return this;
    }

    public CampaignCreateAdGroupFlightInput withAllocationType(Optional<? extends AllocationType> allocationType) {
        Utils.checkNotNull(allocationType, "allocationType");
        this.allocationType = allocationType;
        return this;
    }

    public CampaignCreateAdGroupFlightInput withBudgetInAdvertiserCurrency(double budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = JsonNullable.of(budgetInAdvertiserCurrency);
        return this;
    }

    public CampaignCreateAdGroupFlightInput withBudgetInAdvertiserCurrency(JsonNullable<Double> budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = budgetInAdvertiserCurrency;
        return this;
    }

    public CampaignCreateAdGroupFlightInput withBudgetInImpressions(long budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = JsonNullable.of(budgetInImpressions);
        return this;
    }

    public CampaignCreateAdGroupFlightInput withBudgetInImpressions(JsonNullable<Long> budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = budgetInImpressions;
        return this;
    }

    public CampaignCreateAdGroupFlightInput withDailyTargetInAdvertiserCurrency(double dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = JsonNullable.of(dailyTargetInAdvertiserCurrency);
        return this;
    }

    public CampaignCreateAdGroupFlightInput withDailyTargetInAdvertiserCurrency(JsonNullable<Double> dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = dailyTargetInAdvertiserCurrency;
        return this;
    }

    public CampaignCreateAdGroupFlightInput withDailyTargetInImpressions(long dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = JsonNullable.of(dailyTargetInImpressions);
        return this;
    }

    public CampaignCreateAdGroupFlightInput withDailyTargetInImpressions(JsonNullable<Long> dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = dailyTargetInImpressions;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CampaignCreateAdGroupFlightInput other = (CampaignCreateAdGroupFlightInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CampaignCreateAdGroupFlightInput.class,
    ...
    public final static class Builder {
        ...
        public CampaignCreateAdGroupFlightInput build() {
            return new CampaignCreateAdGroupFlightInput(
                allocationType,
                budgetInAdvertiserCurrency,
                budgetInImpressions,
                dailyTargetInAdvertiserCurrency,
