...
public class AdGroupCreateAdGroupFlightInput {
    ...
    @JsonCreator
    public AdGroupCreateAdGroupFlightInput(
    ...
    public AdGroupCreateAdGroupFlightInput withAllocationType(AllocationType allocationType) {
        Utils.checkNotNull(allocationType, "allocationType");
        this.allocationType = Optional.ofNullable(allocationType);
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withAllocationType(Optional<? extends AllocationType> allocationType) {
        Utils.checkNotNull(allocationType, "allocationType");
        this.allocationType = allocationType;
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withBudgetInAdvertiserCurrency(double budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = JsonNullable.of(budgetInAdvertiserCurrency);
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withBudgetInAdvertiserCurrency(JsonNullable<Double> budgetInAdvertiserCurrency) {
        Utils.checkNotNull(budgetInAdvertiserCurrency, "budgetInAdvertiserCurrency");
        this.budgetInAdvertiserCurrency = budgetInAdvertiserCurrency;
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withBudgetInImpressions(long budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = JsonNullable.of(budgetInImpressions);
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withBudgetInImpressions(JsonNullable<Long> budgetInImpressions) {
        Utils.checkNotNull(budgetInImpressions, "budgetInImpressions");
        this.budgetInImpressions = budgetInImpressions;
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withDailyTargetInAdvertiserCurrency(double dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = JsonNullable.of(dailyTargetInAdvertiserCurrency);
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withDailyTargetInAdvertiserCurrency(JsonNullable<Double> dailyTargetInAdvertiserCurrency) {
        Utils.checkNotNull(dailyTargetInAdvertiserCurrency, "dailyTargetInAdvertiserCurrency");
        this.dailyTargetInAdvertiserCurrency = dailyTargetInAdvertiserCurrency;
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withDailyTargetInImpressions(long dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = JsonNullable.of(dailyTargetInImpressions);
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withDailyTargetInImpressions(JsonNullable<Long> dailyTargetInImpressions) {
        Utils.checkNotNull(dailyTargetInImpressions, "dailyTargetInImpressions");
        this.dailyTargetInImpressions = dailyTargetInImpressions;
        return this;
    }

    public AdGroupCreateAdGroupFlightInput withCampaignFlightId(long campaignFlightId) {
        Utils.checkNotNull(campaignFlightId, "campaignFlightId");
        this.campaignFlightId = campaignFlightId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AdGroupCreateAdGroupFlightInput other = (AdGroupCreateAdGroupFlightInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AdGroupCreateAdGroupFlightInput.class,
    ...
    public final static class Builder {
        ...
        public AdGroupCreateAdGroupFlightInput build() {
            return new AdGroupCreateAdGroupFlightInput(
                allocationType,
                budgetInAdvertiserCurrency,
                budgetInImpressions,
                dailyTargetInAdvertiserCurrency,
