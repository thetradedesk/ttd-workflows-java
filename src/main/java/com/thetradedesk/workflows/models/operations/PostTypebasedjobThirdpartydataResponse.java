...
public class PostTypebasedjobThirdpartydataResponse implements Response {
    ...
    @JsonCreator
    public PostTypebasedjobThirdpartydataResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PostTypebasedjobThirdpartydataResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PostTypebasedjobThirdpartydataResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PostTypebasedjobThirdpartydataResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted
     */
    public PostTypebasedjobThirdpartydataResponse withTypeBasedJobSubmitResponse(TypeBasedJobSubmitResponse typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
     ...
     * Accepted
     */
    public PostTypebasedjobThirdpartydataResponse withTypeBasedJobSubmitResponse(Optional<? extends TypeBasedJobSubmitResponse> typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
        this.typeBasedJobSubmitResponse = typeBasedJobSubmitResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostTypebasedjobThirdpartydataResponse other = (PostTypebasedjobThirdpartydataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostTypebasedjobThirdpartydataResponse.class,
    ...
    public final static class Builder {
        ...
        public PostTypebasedjobThirdpartydataResponse build() {
            return new PostTypebasedjobThirdpartydataResponse(
                contentType,
                statusCode,
                rawResponse,
                typeBasedJobSubmitResponse);
