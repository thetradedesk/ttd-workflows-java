...
public class PostCampaignArchiveRequest {
    ...
    @JsonCreator
    public PostCampaignArchiveRequest(
    ...
    public PostCampaignArchiveRequest withForceArchive(boolean forceArchive) {
        Utils.checkNotNull(forceArchive, "forceArchive");
        this.forceArchive = Optional.ofNullable(forceArchive);
        return this;
    }

    public PostCampaignArchiveRequest withForceArchive(Optional<Boolean> forceArchive) {
        Utils.checkNotNull(forceArchive, "forceArchive");
        this.forceArchive = forceArchive;
        return this;
    }

    public PostCampaignArchiveRequest withRequestBody(List<String> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = Optional.ofNullable(requestBody);
        return this;
    }

    public PostCampaignArchiveRequest withRequestBody(Optional<? extends List<String>> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostCampaignArchiveRequest other = (PostCampaignArchiveRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostCampaignArchiveRequest.class,
    ...
    public final static class Builder {
        ...
        public PostCampaignArchiveRequest build() {
            if (forceArchive == null) {
                forceArchive = _SINGLETON_VALUE_ForceArchive.value();
            }
            return new PostCampaignArchiveRequest(
                forceArchive,
                requestBody);
        }
