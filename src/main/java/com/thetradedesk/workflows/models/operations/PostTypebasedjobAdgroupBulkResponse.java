...
public class PostTypebasedjobAdgroupBulkResponse implements Response {
    ...
    @JsonCreator
    public PostTypebasedjobAdgroupBulkResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PostTypebasedjobAdgroupBulkResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PostTypebasedjobAdgroupBulkResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PostTypebasedjobAdgroupBulkResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted
     */
    public PostTypebasedjobAdgroupBulkResponse withTypeBasedJobSubmitResponse(TypeBasedJobSubmitResponse typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
     ...
     * Accepted
     */
    public PostTypebasedjobAdgroupBulkResponse withTypeBasedJobSubmitResponse(Optional<? extends TypeBasedJobSubmitResponse> typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
        this.typeBasedJobSubmitResponse = typeBasedJobSubmitResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostTypebasedjobAdgroupBulkResponse other = (PostTypebasedjobAdgroupBulkResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostTypebasedjobAdgroupBulkResponse.class,
    ...
    public final static class Builder {
        ...
        public PostTypebasedjobAdgroupBulkResponse build() {
            return new PostTypebasedjobAdgroupBulkResponse(
                contentType,
                statusCode,
                rawResponse,
                typeBasedJobSubmitResponse);
