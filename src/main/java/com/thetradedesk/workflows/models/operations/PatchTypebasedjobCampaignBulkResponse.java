...
public class PatchTypebasedjobCampaignBulkResponse implements Response {
    ...
    @JsonCreator
    public PatchTypebasedjobCampaignBulkResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PatchTypebasedjobCampaignBulkResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PatchTypebasedjobCampaignBulkResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchTypebasedjobCampaignBulkResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted
     */
    public PatchTypebasedjobCampaignBulkResponse withTypeBasedJobSubmitResponse(TypeBasedJobSubmitResponse typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
     ...
     * Accepted
     */
    public PatchTypebasedjobCampaignBulkResponse withTypeBasedJobSubmitResponse(Optional<? extends TypeBasedJobSubmitResponse> typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
        this.typeBasedJobSubmitResponse = typeBasedJobSubmitResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchTypebasedjobCampaignBulkResponse other = (PatchTypebasedjobCampaignBulkResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchTypebasedjobCampaignBulkResponse.class,
    ...
    public final static class Builder {
        ...
        public PatchTypebasedjobCampaignBulkResponse build() {
            return new PatchTypebasedjobCampaignBulkResponse(
                contentType,
                statusCode,
                rawResponse,
                typeBasedJobSubmitResponse);
