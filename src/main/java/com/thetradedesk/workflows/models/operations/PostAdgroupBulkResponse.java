...
public class PostAdgroupBulkResponse implements Response {
    ...
    @JsonCreator
    public PostAdgroupBulkResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PostAdgroupBulkResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PostAdgroupBulkResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PostAdgroupBulkResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted
     */
    public PostAdgroupBulkResponse withBulkJobSubmitResponse(BulkJobSubmitResponse bulkJobSubmitResponse) {
        Utils.checkNotNull(bulkJobSubmitResponse, "bulkJobSubmitResponse");
     ...
     * Accepted
     */
    public PostAdgroupBulkResponse withBulkJobSubmitResponse(Optional<? extends BulkJobSubmitResponse> bulkJobSubmitResponse) {
        Utils.checkNotNull(bulkJobSubmitResponse, "bulkJobSubmitResponse");
        this.bulkJobSubmitResponse = bulkJobSubmitResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostAdgroupBulkResponse other = (PostAdgroupBulkResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostAdgroupBulkResponse.class,
    ...
    public final static class Builder {
        ...
        public PostAdgroupBulkResponse build() {
            return new PostAdgroupBulkResponse(
                contentType,
                statusCode,
                rawResponse,
                bulkJobSubmitResponse);
