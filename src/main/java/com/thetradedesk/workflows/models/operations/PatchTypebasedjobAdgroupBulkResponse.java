...
public class PatchTypebasedjobAdgroupBulkResponse implements Response {
    ...
    @JsonCreator
    public PatchTypebasedjobAdgroupBulkResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PatchTypebasedjobAdgroupBulkResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PatchTypebasedjobAdgroupBulkResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchTypebasedjobAdgroupBulkResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted
     */
    public PatchTypebasedjobAdgroupBulkResponse withTypeBasedJobSubmitResponse(TypeBasedJobSubmitResponse typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
     ...
     * Accepted
     */
    public PatchTypebasedjobAdgroupBulkResponse withTypeBasedJobSubmitResponse(Optional<? extends TypeBasedJobSubmitResponse> typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
        this.typeBasedJobSubmitResponse = typeBasedJobSubmitResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchTypebasedjobAdgroupBulkResponse other = (PatchTypebasedjobAdgroupBulkResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchTypebasedjobAdgroupBulkResponse.class,
    ...
    public final static class Builder {
        ...
        public PatchTypebasedjobAdgroupBulkResponse build() {
            return new PatchTypebasedjobAdgroupBulkResponse(
                contentType,
                statusCode,
                rawResponse,
                typeBasedJobSubmitResponse);
