...
public class PatchCampaignResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public PatchCampaignResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PatchCampaignResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchCampaignResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public PatchCampaignResponse withCampaignPayload(CampaignPayload campaignPayload) {
        Utils.checkNotNull(campaignPayload, "campaignPayload");
     ...
     * OK
     */
    public PatchCampaignResponse withCampaignPayload(Optional<? extends CampaignPayload> campaignPayload) {
        Utils.checkNotNull(campaignPayload, "campaignPayload");
        this.campaignPayload = campaignPayload;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchCampaignResponse other = (PatchCampaignResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchCampaignResponse.class,
    ...
    public final static class Builder {
        ...
        public PatchCampaignResponse build() {
