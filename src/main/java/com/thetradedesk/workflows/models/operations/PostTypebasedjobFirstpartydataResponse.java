...
public class PostTypebasedjobFirstpartydataResponse implements Response {
    ...
    @JsonCreator
    public PostTypebasedjobFirstpartydataResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PostTypebasedjobFirstpartydataResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PostTypebasedjobFirstpartydataResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PostTypebasedjobFirstpartydataResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted
     */
    public PostTypebasedjobFirstpartydataResponse withTypeBasedJobSubmitResponse(TypeBasedJobSubmitResponse typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
     ...
     * Accepted
     */
    public PostTypebasedjobFirstpartydataResponse withTypeBasedJobSubmitResponse(Optional<? extends TypeBasedJobSubmitResponse> typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
        this.typeBasedJobSubmitResponse = typeBasedJobSubmitResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostTypebasedjobFirstpartydataResponse other = (PostTypebasedjobFirstpartydataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostTypebasedjobFirstpartydataResponse.class,
    ...
    public final static class Builder {
        ...
        public PostTypebasedjobFirstpartydataResponse build() {
            return new PostTypebasedjobFirstpartydataResponse(
                contentType,
                statusCode,
                rawResponse,
                typeBasedJobSubmitResponse);
