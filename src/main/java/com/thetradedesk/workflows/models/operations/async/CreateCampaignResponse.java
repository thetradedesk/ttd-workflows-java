...
public class CreateCampaignResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateCampaignResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Created
     */
    public CreateCampaignResponse withCampaignPayload(CampaignPayload campaignPayload) {
        Utils.checkNotNull(campaignPayload, "campaignPayload");
     ...
     * Created
     */
    public CreateCampaignResponse withCampaignPayload(Optional<? extends CampaignPayload> campaignPayload) {
        Utils.checkNotNull(campaignPayload, "campaignPayload");
        this.campaignPayload = campaignPayload;
        return this;
    }
