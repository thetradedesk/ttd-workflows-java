...
public class PostTypebasedjobCampaignBulkResponse implements Response {
    ...
    @JsonCreator
    public PostTypebasedjobCampaignBulkResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PostTypebasedjobCampaignBulkResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PostTypebasedjobCampaignBulkResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PostTypebasedjobCampaignBulkResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted
     */
    public PostTypebasedjobCampaignBulkResponse withTypeBasedJobSubmitResponse(TypeBasedJobSubmitResponse typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
     ...
     * Accepted
     */
    public PostTypebasedjobCampaignBulkResponse withTypeBasedJobSubmitResponse(Optional<? extends TypeBasedJobSubmitResponse> typeBasedJobSubmitResponse) {
        Utils.checkNotNull(typeBasedJobSubmitResponse, "typeBasedJobSubmitResponse");
        this.typeBasedJobSubmitResponse = typeBasedJobSubmitResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostTypebasedjobCampaignBulkResponse other = (PostTypebasedjobCampaignBulkResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostTypebasedjobCampaignBulkResponse.class,
    ...
    public final static class Builder {
        ...
        public PostTypebasedjobCampaignBulkResponse build() {
            return new PostTypebasedjobCampaignBulkResponse(
                contentType,
                statusCode,
                rawResponse,
                typeBasedJobSubmitResponse);
