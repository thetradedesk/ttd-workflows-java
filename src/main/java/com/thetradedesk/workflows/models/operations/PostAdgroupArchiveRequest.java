...
public class PostAdgroupArchiveRequest {
    ...
    @JsonCreator
    public PostAdgroupArchiveRequest(
    ...
    public PostAdgroupArchiveRequest withForceArchive(boolean forceArchive) {
        Utils.checkNotNull(forceArchive, "forceArchive");
        this.forceArchive = Optional.ofNullable(forceArchive);
        return this;
    }

    public PostAdgroupArchiveRequest withForceArchive(Optional<Boolean> forceArchive) {
        Utils.checkNotNull(forceArchive, "forceArchive");
        this.forceArchive = forceArchive;
        return this;
    }

    public PostAdgroupArchiveRequest withRequestBody(List<String> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = Optional.ofNullable(requestBody);
        return this;
    }

    public PostAdgroupArchiveRequest withRequestBody(Optional<? extends List<String>> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostAdgroupArchiveRequest other = (PostAdgroupArchiveRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostAdgroupArchiveRequest.class,
    ...
    public final static class Builder {
        ...
        public PostAdgroupArchiveRequest build() {
            if (forceArchive == null) {
                forceArchive = _SINGLETON_VALUE_ForceArchive.value();
            }
            return new PostAdgroupArchiveRequest(
                forceArchive,
                requestBody);
        }
