...
import com.thetradedesk.workflows.models.operations.PostPubapiRequestBuilder;
import com.thetradedesk.workflows.models.operations.PostPubapiResponse;
import com.thetradedesk.workflows.models.operations.PostPubapiResponseBody;
...
public class PubApi implements
            MethodCallPostPubapi {

    private final SDKConfiguration sdkConfiguration;

    PubApi(SDKConfiguration sdkConfiguration) {
     ...
     */
    public PostPubapiRequestBuilder postPubapi() {
        return new PostPubapiRequestBuilder(this);
    }
     ...
     */
    public PostPubapiResponse postPubapiDirect() throws Exception {
        return postPubapi(Optional.empty(), Optional.empty());
    }
     ...
     * @throws Exception if the API call fails
     */
    public PostPubapiResponse postPubapi(
        ...
        PostPubapiResponse.Builder _resBuilder = 
            PostPubapiResponse
                .builder()
        ...
        PostPubapiResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                PostPubapiResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<PostPubapiResponseBody>() {});
