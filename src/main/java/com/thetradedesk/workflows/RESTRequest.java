...
import com.thetradedesk.workflows.models.operations.PostRestrequestRequestBuilder;
import com.thetradedesk.workflows.models.operations.PostRestrequestResponse;
import com.thetradedesk.workflows.models.operations.PostRestrequestResponseBody;
...
public class RESTRequest implements
            MethodCallPostRestrequest {
     ...
     */
    public PostRestrequestRequestBuilder postRestrequest() {
        return new PostRestrequestRequestBuilder(this);
    }
     ...
     */
    public PostRestrequestResponse postRestrequestDirect() throws Exception {
        return postRestrequest(Optional.empty(), Optional.empty());
    }
     ...
     * @throws Exception if the API call fails
     */
    public PostRestrequestResponse postRestrequest(
        ...
        PostRestrequestResponse.Builder _resBuilder = 
        ...
        PostRestrequestResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                PostRestrequestResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<PostRestrequestResponseBody>() {});
